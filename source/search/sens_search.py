...
from source.definit.contract import Contract, calc_reward, calc_salary
from source.definit.project import Project, projects, ExactResults
...
def tm_sens_rate():
    ...
    for proj in projects:
        ...
        for nu in np.arange(0.0, 1.009, 0.01):
            ...
            best_salary, _ = opt_contract_peakfinder(
                proj,
                cont,
                "lh",
                Smin,
